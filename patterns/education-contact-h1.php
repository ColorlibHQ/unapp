<?php
/**
 * Title: Courses: contact the school (opening a page)
 * Slug: unapp/education-contact-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Ask before you book', 'unapp' ); ?></h1>
<!-- /wp:heading -->
