...
?>
<!-- wp:group {"align":"full","gradient":"primary-to-accent","textColor":"base","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"},"blockGap":"0"},"elements":{"link":{"color":{"text":"var:preset|color|base"}},"heading":{"color":{"text":"var:preset|color|base"}}}},"layout":{"type":"constrained"},"anchor":"book"} -->
<div class="wp-block-group alignfull has-primary-to-accent-gradient-background has-background has-base-color has-text-color has-link-color" id="book" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);">
...
<p class="has-text-align-center has-base-color has-text-color has-large-font-size"><?php esc_html_e( 'An hour with a coach, an empty bar and no obligation to join anything at the end of it.', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-text-color has-base-background-color has-background wp-element-button" href="<?php echo esc_url( 'mailto:hello@archtwelve.example?subject=' . rawurlencode( _x( 'Free session', 'Email subject line', 'unapp' ) ) ); ?>"><?php esc_html_e( 'Book your free session', 'unapp' ); ?></a></div>
<!-- /wp:button -->
