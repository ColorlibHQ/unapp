<?php
/**
 * Title: Portfolio: availability and enquiries
 * Slug: unapp/portfolio-contact
 * Categories: unapp, unapp_portfolio, unapp_utility, contact
 * Keywords: portfolio, contact, availability, enquiry, freelance, hire
 * Viewport Width: 1400
 * Description: Current availability, an email address and a short brief of what to include in a first message.
 *
 * @package Unapp
 */
...
<!-- wp:column {"verticalAlignment":"top","width":"55%","style":{"spacing":{"blockGap":"var:preset|spacing|18"}}} -->
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Booking from February', 'unapp' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:group {"className":"is-style-card","style":{"border":{"radius":"18px"},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|16"}},"layout":{"type":"constrained"}} -->
