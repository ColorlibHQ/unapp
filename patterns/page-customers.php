 ...
 * Slug: unapp/page-customers
 * Categories: unapp_page
 * Keywords: starter, customers, testimonials, proof, case study
 * Block Types: core/post-content
 * Post Types: page, wp_template
 * Viewport Width: 1400
 * Description: Social proof end to end: testimonials, logos, ratings, a case study and press mentions.
 *
 * @package Unapp
 */

?>
<!-- wp:pattern {"slug":"unapp/testimonials-h1"} /-->
