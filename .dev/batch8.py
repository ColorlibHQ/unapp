...
PAGES = [
 ("page-saas", "SaaS landing page", "starter, saas, landing, home, marketing",
  ...
  ["hero-split","logo-cloud","features-zigzag","how-it-works","screens","testimonials","pricing","collaborate","faq","cta-band"]),
 ("page-features", "Features page", "starter, features, product, tour",
  "A full product tour: why teams move, a bento grid, alternating rows, integrations, security and a call to action.",
  ["features-offset-h1","features-bento","how-it-works","features-zigzag","feature-checklist","integrations","security","cta-band"]),
 ("page-customers", "Customers page", "starter, customers, testimonials, proof, case study",
  "Social proof end to end: testimonials, logos, ratings, a case study and press mentions.",
  ["testimonials-h1","logo-cloud","ratings","collaborate","case-study","screens","testimonial-feature","press","cta-band"]),
 ...
 ("page-careers", "Careers page", "starter, careers, jobs, hiring, culture",
  ...
  ["values-h1","team","timeline","careers","cta-band"]),
 ...
 ("page-pricing-full", "Pricing page (detailed)", "starter, pricing, plans, compare, faq",
  ...
  ["pricing-h1","pricing-compare","security","faq","cta-band"]),
]
