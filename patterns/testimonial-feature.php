...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="#case-study"><?php esc_html_e( 'Read the case study', 'unapp' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
