<?php
/**
 * Title: Contact: details and form (opening a page)
 * Slug: unapp/contact-split-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Tell us what you are building', 'unapp' ); ?></h1>
<!-- /wp:heading -->
