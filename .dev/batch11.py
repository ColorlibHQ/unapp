...
terms = ('<!-- wp:terms-query {"termQuery":{"taxonomy":"category","perPage":6,"hideEmpty":true,'
         ...
         + group(
             ...
             style_variation="is-style-card", radius="16px", layout="flex", orientation="vertical", gap="20",
...
body = section(
    columns([
        column(image(uri("assets/images/avatars/avatar-4.svg"), tattr("Author portrait placeholder"),
                     width="180px", height="180px", radius="999px"), width="26%", vertical_align="center"),
        column(
            eyebrow(t("Written by", "Section eyebrow label"), align="left") + "\n" +
            heading(t("Ines Kovač"), size="xx-large") + "\n" +
