<?php
/**
 * Title: Property: fees (opening a page)
 * Slug: unapp/realestate-fees-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Our fees, in public', 'unapp' ); ?></h1>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
