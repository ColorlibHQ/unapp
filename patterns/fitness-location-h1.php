<?php
/**
 * Title: Fitness: location and hours (opening a page)
 * Slug: unapp/fitness-location-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Arch 12, Bonnington Yard', 'unapp' ); ?></h1>
<!-- /wp:heading -->
