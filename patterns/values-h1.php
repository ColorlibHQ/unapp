<?php
/**
 * Title: Company values (opening a page)
 * Slug: unapp/values-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Three rules we hold to', 'unapp' ); ?></h1>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
