...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"textAlign":"left","fontSize":"xxx-large","style":{"typography":{"lineHeight":"1.05"}}} -->
<h1 class="wp-block-heading has-text-align-left has-xxx-large-font-size" style="line-height:1.05;"><?php esc_html_e( 'Mara Lindqvist', 'unapp' ); ?></h1>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/abstract/studio-2.svg' ) ); ?>" alt="<?php esc_attr_e( 'Portrait placeholder', 'unapp' ); ?>" style="border-radius:20px;aspect-ratio:3/2;width:100%;height:auto"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
</div>
