...
PAGES = [
 ...
 ("page-features", "Features page", "starter, features, product, tour",
  ...
  ["features-offset","features-bento","how-it-works","features-zigzag","feature-checklist","integrations","security","cta-band"]),
 ("page-customers", "Customers page", "starter, customers, testimonials, proof, case study",
  ...
  ["logo-cloud","ratings","collaborate","case-study","testimonials","screens","testimonial-feature","press","cta-band"]),
