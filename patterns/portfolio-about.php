...
<!-- wp:image {"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"16px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/abstract/desk.svg' ) ); ?>" alt="<?php esc_attr_e( 'Studio placeholder', 'unapp' ); ?>" style="border-radius:16px;"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e( 'Fifteen years, three cities, one obsession', 'unapp' ); ?></h2>
<!-- /wp:heading -->
