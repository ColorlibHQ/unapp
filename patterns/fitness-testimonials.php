...
$unapp_fitness_stories = array(
	array(
		'image' => 'avatar-2',
		'name' => _x( "Priya Raman", 'Member story', 'unapp' ),
		'meta' => _x( "Member for two years", 'Member story', 'unapp' ),
		'quote' => _x( "I joined at forty-one having never lifted anything heavier than a toddler. I deadlift a hundred kilos now. Nobody was ever weird about it.", 'Member story', 'unapp' ),
	),
	array(
		'image' => 'avatar-7',
		'name' => _x( "Mark Ellison", 'Member story', 'unapp' ),
		'meta' => _x( "Member for eight months", 'Member story', 'unapp' ),
		'quote' => _x( "I have had three gym memberships and used none of them. This is the first place where a coach noticed I had stopped coming and messaged me.", 'Member story', 'unapp' ),
	),
	array(
		'image' => 'avatar-9',
		'name' => _x( "Chloe Boateng", 'Member story', 'unapp' ),
		'meta' => _x( "Member for four years", 'Member story', 'unapp' ),
		'quote' => _x( "I came back six weeks after having my son. They rewrote the whole programme around what my body could actually do that month.", 'Member story', 'unapp' ),
	),
);
?>
