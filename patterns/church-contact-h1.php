...
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="https://maps.google.com/?q=Riverside+Church,+12+Mill+Lane,+Chesterfield+S40+1RT"><?php esc_html_e( 'Get directions', 'unapp' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
