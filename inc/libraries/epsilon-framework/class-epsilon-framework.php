...
require_once plugin_dir_path( __FILE__ ) . '/class-epsilon-autoloader.php';
...
class Epsilon_Framework {
	...
	public function customizer_enqueue_scripts() {
		...
		wp_localize_script( 'epsilon-object', 'EpsilonTranslations', array(
			'remove'     => esc_html__( 'Remove', 'unapp' ),
			'add'        => esc_html__( 'Add', 'unapp' ),
			'selectFile' => esc_html__( 'Upload image', 'unapp' ),
			'row'        => esc_html__( 'Row', 'unapp' ),
		) );
