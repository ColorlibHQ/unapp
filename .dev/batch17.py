...
niche_footer(
    ...
    links_head="Visit", links=[("Plan your visit", home_anchor("visit")), ("Service times", home_anchor("times")),
                               ("Ministries", home_anchor("ministries")), ("Give", home_anchor("give"))],
...
niche_footer(
    ...
    links_head="Train", links=[("Timetable", home_anchor("timetable")), ("Memberships", home_anchor("memberships")),
                               ("Coaches", home_anchor("coaches")), ("Book a session", home_anchor("book"))],
...
niche_footer(
    ...
    links_head="Advice", links=[("Services", home_anchor("services")), ("Our fees", home_anchor("fees")),
                                ("The team", home_anchor("team")), ("Book a call", home_anchor("contact"))],
    contact_head="Office",
...
niche_footer(
    ...
    links_head="Work", links=[("Selected work", home_anchor("work")), ("Services and rates", home_anchor("services")),
                              ("About", home_anchor("about")), ("Enquiries", home_anchor("contact"))],
...
niche_footer(
    ...
    links_head="Read", links=[("Archive", BLOG_URL), ("Topics", home_anchor("topics")),
                              ("About", home_anchor("about")),
                              ("Pitch an essay", mailto("editor@theslowbuild.example", "Essay pitch"))],
...
niche_footer(
    ...
    links_head="Eat", links=[("This week's menu", home_anchor("menu")), ("Book a table", home_anchor("bookings")),
                             ("The kitchen", home_anchor("kitchen")),
                             ("Private dining", mailto("eat@wharfstreet.example", "Private dining"))],
...
niche_footer(
    ...
    links_head="Studio", links=[("Work", home_anchor("work")), ("Capabilities", home_anchor("services")),
                                ("Engagements", home_anchor("engagements")), ("Start a project", home_anchor("contact"))],
...
niche_footer(
    ...
    links_head="Shop", links=[("Everything in stock", SHOP_URL), ("How it is made", home_anchor("making")),
                              ("Delivery and returns", home_anchor("delivery")),
                              ("Repairs", mailto("workshop@sheafworks.example", "Repair"))],
...
for slug, title, cat, blurb, lh, links, ch, clines, socials, ph in [
    ("footer-realestate", "Footer: property", "unapp_realestate",
     ...
     "Property", [("For sale", home_anchor("listings")), ("Our fees", home_anchor("fees")),
                  ("Book a valuation", home_anchor("valuation")), ("Email the office", "mailto:hello@lansdown.example")],
    ...
    ("footer-medical", "Footer: practice", "unapp_medical",
     ...
     "Patients", [("Treatments", home_anchor("treatments")), ("The team", home_anchor("team")),
                  ("Joining the practice", home_anchor("questions")), ("Emergencies", home_anchor("hours"))],
    ...
    ("footer-education", "Footer: courses", "unapp_education",
     ...
     "Learn", [("This term", home_anchor("courses")), ("Tutors", home_anchor("tutors")),
               ("Gift vouchers", mailto("hello@oldschoolhall.example", "Gift voucher")), ("Questions", home_anchor("questions"))],
    ...
    ("footer-events", "Footer: conference", "unapp_events",
     ...
     "Attend", [("Programme", home_anchor("programme")), ("Speakers", home_anchor("speakers")),
                ("Tickets", home_anchor("tickets")), ("Access and travel", home_anchor("venue"))],
