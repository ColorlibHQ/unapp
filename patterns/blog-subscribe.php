...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|22"}},"layout":{"type":"constrained","contentSize":"620px"}} -->
...
<p class="has-text-align-center has-text-color has-large-font-size" style="color:rgba(255,255,255,0.86);"><?php esc_html_e( 'Four thousand people read it over coffee. No tracking pixels, no sequence, one click to leave.', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
