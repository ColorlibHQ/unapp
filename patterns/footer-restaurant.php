 ...
 * Slug: unapp/footer-restaurant
 * Categories: unapp, unapp_restaurant, footer
 * Keywords: footer, restaurant, hours, booking, address
 * Block Types: core/template-part/footer
 * Viewport Width: 1400
 * Description: A restaurant footer: what the kitchen does, opening nights and where to find the room.
 *
 * @package Unapp
 */
...
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'Ten tables on Wharf Street. Dinner Wednesday to Saturday, lunch on Sunday, and a menu that changes weekly.', 'Footer tagline', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<?php endif; ?>
...
<!-- wp:social-link {"url":"https://tripadvisor.com","service":"tripadvisor"} /-->
</ul>
<!-- /wp:social-links -->
</div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:22%;">
<!-- wp:heading {"fontSize":"small","style":{"typography":{"fontWeight":"600","letterSpacing":"0.06em"}}} -->
<h2 class="wp-block-heading has-small-font-size" style="font-weight:600;letter-spacing:0.06em;"><?php echo esc_html_x( 'From the kitchen', 'Footer column heading', 'unapp' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-column" style="flex-basis:22%;">
<!-- wp:heading {"fontSize":"small","style":{"typography":{"fontWeight":"600","letterSpacing":"0.06em"}}} -->
<h2 class="wp-block-heading has-small-font-size" style="font-weight:600;letter-spacing:0.06em;"><?php echo esc_html_x( 'The room', 'Footer column heading', 'unapp' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( '41 Wharf Street, Bristol BS1 4RW', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( '0117 555 0192', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'Wed–Sat dinner · Sun lunch', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'eat@wharfstreet.example', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
</div>
