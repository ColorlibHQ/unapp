...
$parent_attr = array(
	'id'    => ! empty( $fields['featured_left_section_unique_id'] ) ? array( $fields['featured_left_section_unique_id'] ) : array(),
...
<div class="colorlib-work-featured colorlib-work-featured-left colorlib-bg-white" data-customizer-section-id="unapp_repeatable_section" data-section="<?php echo esc_attr( $section_id ); ?>">
    <div <?php $attr_helper->generate_attributes( $parent_attr ); ?>>
        ...
        ?>
        <div class="<?php echo esc_attr( Unapp_Helper::container_class( 'featured_left', $fields ) ); ?>">
            ...
            <div class="row mobile-wrap">
	            <?php if ( $fields['featured_left_row_title_align'] == 'left' ){ ?>
                <?php if( ! empty( $fields['featured_image'] ) ) { ?>
                <div class="col-md-5 animate-box" data-animate-effect="<?php echo esc_attr( $fields[ 'featured_left_image_animate' ] ); ?>">
                    <div class="mobile-img">
                        <img src="<?php echo esc_url( $fields['featured_image'] ); ?>" alt="<?php echo wp_kses_post( $fields['featured_title'] ); ?>">
                    </div>
                </div>
                <?php } ?>
                <div class="col-md-<?php print $section_content_col; ?> animate-box" data-animate-effect="<?php echo esc_attr( $fields[ 'featured_left_text_animate' ] ); ?>">
                    <div class="desc">
                ...
                <?php } else {
	                ...
	                <?php if( ! empty( $fields['featured_image'] ) ) { ?>
                        <div class="col-md-5 animate-box" data-animate-effect="<?php echo esc_attr( $fields[ 'featured_left_image_animate' ] ); ?>">
                            <div class="mobile-img">
                                <img src="<?php echo esc_url( $fields['featured_image'] ); ?>"
                                     alt="<?php echo wp_kses_post( $fields['featured_title'] ); ?>">
                            </div>
                        </div>
			            <?php
		            }
