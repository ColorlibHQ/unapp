...
Epsilon_Customizer::add_field(
	'epsilon_dropdown_menu_item_color',
	array(
		'type'        => 'epsilon-color-picker',
...
Epsilon_Customizer::add_field(
	'epsilon_dropdown_menu_item_hover_color',
	array(
		'type'        => 'epsilon-color-picker',
...
Epsilon_Customizer::add_field(
	'epsilon_dropdown_menu_item_active_color',
	array(
		'type'        => 'epsilon-color-picker',
...
Epsilon_Customizer::add_field(
	...
	array(
		'type'        => 'epsilon-color-picker',
		'label'       => esc_html__( 'Footer Text Color.', 'unapp' ),
		'description' => esc_html__( 'TThe color used for the footer text.', 'unapp' ),
		'sanitize_callback' => 'sanitize_text_field',
		'section'     => 'colors',
		'default'     => '#808080',
...
Epsilon_Customizer::add_field(
	...
	array(
		'type'        => 'epsilon-color-picker',
		'label'       => esc_html__( 'Footer Link Color.', 'unapp' ),
