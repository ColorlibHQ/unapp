<?php
/**
 * Title: Restaurant: menu (opening a page)
 * Slug: unapp/restaurant-menu-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'The menu changes on Wednesday', 'unapp' ); ?></h1>
<!-- /wp:heading -->
