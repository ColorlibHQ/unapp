<?php
/**
 * Title: Church: what to expect (opening a page)
 * Slug: unapp/church-visit-h1
 * Inserter: no
...
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"},"blockGap":"var:preset|spacing|60"}},"layout":{"type":"constrained"},"anchor":"visit"} -->
<div class="wp-block-group alignfull" id="visit" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70);">
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'What actually happens', 'unapp' ); ?></h1>
<!-- /wp:heading -->
