<?php
/**
 * Title: Fitness: memberships (opening a page)
 * Slug: unapp/fitness-memberships-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Three ways to train here', 'unapp' ); ?></h1>
<!-- /wp:heading -->
