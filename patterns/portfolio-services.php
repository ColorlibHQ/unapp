...
<!-- /wp:group -->
<!-- wp:columns {"align":"wide","className":"is-style-divided","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|50","left":"var:preset|spacing|50"}}}} -->
...
<h3 class="wp-block-heading has-x-large-font-size"><?php echo esc_html( $unapp_offer['title'] ); ?></h3>
<!-- /wp:heading -->
