...
$unapp_church_expect = array(
	array(
		'icon'  => 'clock',
		'title' => _x( 'Ninety minutes', 'Church first-visit card title', 'unapp' ),
		'text'  => _x( "Songs, a talk and coffee afterwards. You are free to leave whenever you like.", 'Church first-visit card text', 'unapp' ),
	),
	array(
		'icon'  => 'map-pin',
		'title' => _x( 'Parking is free', 'Church first-visit card title', 'unapp' ),
		'text'  => _x( "Behind the building, entrance on Mill Lane. Ten spaces are reserved for visitors.", 'Church first-visit card text', 'unapp' ),
	),
	array(
		'icon'  => 'users',
		'title' => _x( 'Children are welcome', 'Church first-visit card title', 'unapp' ),
		'text'  => _x( "Creche for under-3s, groups up to Year 6, and nobody minds noise in the service.", 'Church first-visit card text', 'unapp' ),
	),
	array(
		'icon'  => 'heart',
		'title' => _x( 'Wear whatever you own', 'Church first-visit card title', 'unapp' ),
		'text'  => _x( "You will see suits and you will see trainers. Both are fine.", 'Church first-visit card text', 'unapp' ),
	),
);
?>
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|16"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group">
...
<h3 class="wp-block-heading has-medium-font-size"><?php echo $unapp_church_item['title']; ?></h3>
<!-- /wp:heading -->
