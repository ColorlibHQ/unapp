...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/abstract/ledger.svg' ) ); ?>" alt="<?php esc_attr_e( 'Planning document placeholder', 'unapp' ); ?>" style="border-radius:16px;box-shadow:var(--wp--preset--shadow--card);"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
</div>
