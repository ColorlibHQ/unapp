<?php
/**
 * Title: Practice: treatments (opening a page)
 * Slug: unapp/medical-services-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'What we do, in plain English', 'unapp' ); ?></h1>
<!-- /wp:heading -->
