<?php
/**
 * Title: Event: venue and access
 * Slug: unapp/events-venue
 * Categories: unapp, unapp_events, unapp_utility, contact
 * Keywords: events, venue, travel, access, accessibility, conference
 * Viewport Width: 1400
 * Description: Where the event is, when, and what access provision it makes.
 *
 * @package Unapp
 */
...
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'The Assembly Rooms, Bristol', 'unapp' ); ?></h2>
<!-- /wp:heading -->
