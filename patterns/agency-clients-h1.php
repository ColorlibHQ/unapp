<?php
/**
 * Title: Agency: selected clients (opening a page)
 * Slug: unapp/agency-clients-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Who we have done it for', 'unapp' ); ?></h1>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
