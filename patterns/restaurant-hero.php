...
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-xxx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Ten tables, one menu, whatever the market had', 'unapp' ); ?></h1>
<!-- /wp:heading -->
