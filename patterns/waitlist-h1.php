<?php
/**
 * Title: Waitlist / coming soon (opening a page)
 * Slug: unapp/waitlist-h1
 * Inserter: no
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"textAlign":"center","textColor":"base","fontSize":"xx-large","style":{"typography":{"lineHeight":"1.2"}}} -->
<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Something new is nearly ready', 'unapp' ); ?></h1>
<!-- /wp:heading -->
