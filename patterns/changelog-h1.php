<?php
/**
 * Title: Changelog entries (opening a page)
 * Slug: unapp/changelog-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'What shipped recently', 'unapp' ); ?></h1>
<!-- /wp:heading -->
