...
class Epsilon_Text_Generator {
	 ...
	 */
	public function words_array( $count = 1, $tags = false ) {
	 ...
	 */
	public function sentences_array( $count = 1, $tags = false ) {
	...
	public function sentences( $count = 1, $tags = false, $array = false ) {
		$sentences = array();
		for ( $i = 0; $i < $count; $i ++ ) {
			$sentences[] = $this->words_array( $this->gauss( 24.46, 5.08 ) );
		}
	 ...
	 */
	public function paragraphs_array( $count = 1, $tags = false ) {
