...
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Programme', 'unapp' ); ?>","url":"#programme","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Speakers', 'unapp' ); ?>","url":"#speakers","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Tickets', 'unapp' ); ?>","url":"#tickets","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Access and travel', 'unapp' ); ?>","url":"#access","kind":"custom","isTopLevelLink":true} /-->
<!-- /wp:navigation -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"22%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
