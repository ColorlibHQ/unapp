 ...
 * Slug: unapp/agency-hero
 * Categories: unapp, unapp_agency, banner, featured
 * Keywords: agency, studio, hero, introduction, creative
 * Viewport Width: 1400
 * Description: A studio introduction with two calls to action and an image.
 *
 * @package Unapp
 */
...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/abstract/studio-2.svg' ) ); ?>" alt="<?php esc_attr_e( 'Studio', 'unapp' ); ?>" style="border-radius:20px;aspect-ratio:3/2;width:100%;height:auto"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
</div>
