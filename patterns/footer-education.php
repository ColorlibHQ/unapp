...
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'This term', 'unapp' ); ?>","url":"#courses","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Tutors', 'unapp' ); ?>","url":"#tutors","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Gift vouchers', 'unapp' ); ?>","url":"#vouchers","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Questions', 'unapp' ); ?>","url":"#faq","kind":"custom","isTopLevelLink":true} /-->
<!-- /wp:navigation -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"22%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
