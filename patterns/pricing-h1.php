<?php
/**
 * Title: Pricing table (opening a page)
 * Slug: unapp/pricing-h1
 * Inserter: no
...
<div class="wp-block-group alignfull is-style-section-soft" id="pricing" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group">
		...
		<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Simple, transparent pricing', 'unapp' ); ?></h1>
		<!-- /wp:heading -->
