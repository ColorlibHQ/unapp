<?php
/**
 * Title: Church: our story (opening a page)
 * Slug: unapp/church-story-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'A hundred and forty years of Tuesdays', 'unapp' ); ?></h1>
<!-- /wp:heading -->
