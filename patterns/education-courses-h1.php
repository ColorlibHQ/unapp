<?php
/**
 * Title: Courses: the timetable (opening a page)
 * Slug: unapp/education-courses-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Four courses, and a waiting list for two of them', 'unapp' ); ?></h1>
<!-- /wp:heading -->
