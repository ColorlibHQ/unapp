...
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Plan your visit', 'unapp' ); ?>","url":"<?php echo esc_url( home_url( '/#visit' ) ); ?>","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Service times', 'unapp' ); ?>","url":"<?php echo esc_url( home_url( '/#times' ) ); ?>","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Ministries', 'unapp' ); ?>","url":"<?php echo esc_url( home_url( '/#ministries' ) ); ?>","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Give', 'unapp' ); ?>","url":"<?php echo esc_url( home_url( '/#give' ) ); ?>","kind":"custom","isTopLevelLink":true} /-->
<!-- /wp:navigation -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"22%","style":{"spacing":{"blockGap":"var:preset|spacing|30"}}} -->
