<?php
/**
 * Title: Footer: blog and magazine
 * Slug: unapp/footer-blog
 * Categories: unapp, unapp_blog, footer
 * Keywords: footer, blog, magazine, subscribe, rss
 * Block Types: core/template-part/footer
 * Viewport Width: 1400
 * Description: A publication footer: what it is, how often it appears, and where to subscribe.
 *
 * @package Unapp
 */
...
<!-- wp:social-link {"url":"https://mastodon.social","service":"mastodon"} /-->
<!-- wp:social-link {"url":"https://example.com/feed","service":"rss"} /-->
</ul>
<!-- /wp:social-links -->
</div>
<!-- /wp:column -->
...
<div class="wp-block-column" style="flex-basis:22%;">
<!-- wp:heading {"fontSize":"small","style":{"typography":{"fontWeight":"600","letterSpacing":"0.06em"}}} -->
<h2 class="wp-block-heading has-small-font-size" style="font-weight:600;letter-spacing:0.06em;"><?php echo esc_html_x( 'Recent essays', 'Footer column heading', 'unapp' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-column" style="flex-basis:22%;">
<!-- wp:heading {"fontSize":"small","style":{"typography":{"fontWeight":"600","letterSpacing":"0.06em"}}} -->
<h2 class="wp-block-heading has-small-font-size" style="font-weight:600;letter-spacing:0.06em;"><?php echo esc_html_x( 'Elsewhere', 'Footer column heading', 'unapp' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'editor@theslowbuild.example', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'RSS feed', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"fontSize":"small","style":{"color":{"text":"rgba(255,255,255,0.72)"}}} -->
<p class="has-text-color has-small-font-size" style="color:rgba(255,255,255,0.72);"><?php echo esc_html_x( 'Corrections published as corrections', 'Footer contact line', 'unapp' ); ?></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
</div>
