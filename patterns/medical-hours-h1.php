<?php
/**
 * Title: Practice: hours and access (opening a page)
 * Slug: unapp/medical-hours-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( '42 Fore Street, with parking behind', 'unapp' ); ?></h1>
<!-- /wp:heading -->
...
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="tel:+4413925550146"><?php esc_html_e( 'Book an appointment', 'unapp' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
