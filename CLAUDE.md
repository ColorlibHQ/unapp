...
| Colour palettes (6) | `styles/colors/*.json` — **colour only**, or the editor drops them from the Colors group |
...
| Curated full looks (5) | `styles/{emerald,sunset,graphite,violet,midnight}.json` — a palette paired with a typeface |
