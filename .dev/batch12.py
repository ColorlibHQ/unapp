...
DEMOS = [
 ...
 ("demo-restaurant", "Starter site: Restaurant", "starter site, restaurant, cafe, bistro, food, menu",
  "The home page for the Restaurant starter site: cover hero, the week's menu, the kitchen, reviews, hours and a booking band.",
  ["restaurant-hero","restaurant-menu","restaurant-kitchen","restaurant-reviews","restaurant-hours","restaurant-cta"]),
 ("demo-agency", "Starter site: Agency", "starter site, agency, studio, creative, design, freelance",
  "The home page for the Agency starter site: introduction, capabilities, clients, engagements, the studio and an enquiry form.",
  ["agency-hero","agency-services","agency-clients","agency-engagements","agency-team","agency-contact"]),
 ("demo-shop", "Starter site: Shop", "starter site, shop, store, ecommerce, woocommerce, products",
  "The home page for the Shop starter site: storefront hero, newest products, promises, the workshop, delivery answers and a closing band.",
  ["shop-hero","shop-featured","shop-promise","shop-workshop","shop-faq","shop-cta"]),
 ("demo-realestate", "Starter site: Property", "starter site, real estate, property, estate agent, homes",
  "The home page for the Property starter site: introduction, current listings, published fees and a valuation enquiry.",
  ["realestate-hero","realestate-listings","realestate-fees","realestate-valuation"]),
 ("demo-medical", "Starter site: Practice", "starter site, medical, dental, clinic, practice, health",
  "The home page for the Practice starter site: introduction, treatments, clinicians, patient questions and opening hours.",
  ["medical-hero","medical-services","medical-team","medical-faq","medical-hours"]),
 ("demo-education", "Starter site: Courses", "starter site, education, courses, school, workshop, learning",
  "The home page for the Courses starter site: introduction, the term's courses, tutors, questions and a booking band.",
  ["education-hero","education-courses","education-tutors","education-faq","education-cta"]),
 ("demo-events", "Starter site: Conference", "starter site, events, conference, tickets, speakers",
