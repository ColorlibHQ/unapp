<?php
/**
 * Title: Features: asymmetric (opening a page)
 * Slug: unapp/features-offset-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'One place to plan, decide and ship', 'unapp' ); ?></h1>
<!-- /wp:heading -->
