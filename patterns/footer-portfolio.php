...
<!-- wp:column {"width":"34%","style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
...
<!-- /wp:column -->
<!-- wp:column {"width":"22%","style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
...
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Selected work', 'unapp' ); ?>","url":"#work","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Services and rates', 'unapp' ); ?>","url":"#services","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'About', 'unapp' ); ?>","url":"#about","kind":"custom","isTopLevelLink":true} /-->
<!-- wp:navigation-link {"label":"<?php esc_attr_e( 'Enquiries', 'unapp' ); ?>","url":"#contact","kind":"custom","isTopLevelLink":true} /-->
<!-- /wp:navigation -->
</div>
<!-- /wp:column -->
<!-- wp:column {"width":"22%","style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
...
<!-- wp:columns {"verticalAlignment":"center","align":"wide","isStackedOnMobile":false,"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|20","left":"var:preset|spacing|20"}}}} -->
