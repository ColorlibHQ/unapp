 ...
 * Viewport Width: 1400
 * Description: Four counting numbers about the studio, each with a line on why it matters.
 *
 * @package Unapp
 */
...
$unapp_fitness_stats = array(
	array(
		'number' => _x( "340", 'Studio statistic', 'unapp' ),
		'label' => _x( "members", 'Studio statistic', 'unapp' ),
		'note' => _x( "Most of whom had never touched a barbell before they walked in.", 'Studio statistic', 'unapp' ),
	),
	array(
		'number' => _x( "42", 'Studio statistic', 'unapp' ),
		'label' => _x( "classes a week", 'Studio statistic', 'unapp' ),
		'note' => _x( "Across two rooms, from 06:00 to 20:30.", 'Studio statistic', 'unapp' ),
	),
	array(
		'number' => _x( "12", 'Studio statistic', 'unapp' ),
		'label' => _x( "people per class", 'Studio statistic', 'unapp' ),
		'note' => _x( "The number we cap it at, permanently. It is the whole point.", 'Studio statistic', 'unapp' ),
	),
	array(
		'number' => _x( "7", 'Studio statistic', 'unapp' ),
		'label' => _x( "coaches", 'Studio statistic', 'unapp' ),
		'note' => _x( "All of them qualified, all of them still competing or still learning.", 'Studio statistic', 'unapp' ),
	),
);
?>
