<?php
/**
 * Title: Church: giving (opening a page)
 * Slug: unapp/church-giving-h1
 * Inserter: no
...
<!-- /wp:paragraph -->
<!-- wp:heading {"level":1,"textColor":"base","fontSize":"xx-large","style":{"typography":{"lineHeight":"1.2"}}} -->
<h1 class="wp-block-heading has-base-color has-text-color has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Every gift stays close to home', 'unapp' ); ?></h1>
<!-- /wp:heading -->
