<?php
/**
 * Title: Testimonials grid (opening a page)
 * Slug: unapp/testimonials-h1
 * Inserter: no
...
<h1 class="wp-block-heading has-text-align-center has-xx-large-font-size" style="line-height:1.2;"><?php esc_html_e( 'Teams don\'t go back', 'unapp' ); ?></h1>
<!-- /wp:heading -->
